...
preprocessor = ColumnTransformer(
    ...
    remainder='passthrough'  # 对未处理的列（如二分类特征和ID列）保持原样
)
...
categorical_columns = list(pipeline.named_steps['preprocessor'].named_transformers_['cat'].named_steps['onehot'].get_feature_names_out(categorical_features))
all_columns = numeric_columns + categorical_columns + id_column + binary_columns

# 5. 将处理后的数据转换为DataFrame
