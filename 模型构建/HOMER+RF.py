...
# 5. 保存结果到Excel
def save_results_to_excel(all_fold_metrics, best_params, filename='HOMER_RF_results.xlsx'):
    """将结果保存到Excel文件"""
    # 创建结果DataFrame
...
def main():
    ...
    # 定义基础分类器 (Random Forest)
    base_rf = RandomForestClassifier(random_state=42)

    # 定义HOMER模型
    homer = HOMER(base_rf, random_state=42)
