...
# 5. 保存结果到Excel
def save_results_to_excel(all_fold_metrics, best_params, filename='HOMER_XGBoost_results.xlsx'):
    """将结果保存到Excel文件"""
    # 创建结果DataFrame
...
def main():
    ...
    # 定义HOMER模型
    homer = HOMER(base_xgb, random_state=42)
    ...
    param_grid = {
        ...
        'base_estimator__gamma': [0, 0.1]
    }

    print("开始HOMER+XGBoost网格搜索...")
